 ...
 * slickcontent
 */
$GLOBALS[ 'TCA' ][ 'tt_content' ][ 'ctrl' ][ 'typeicon_classes' ][ 'slickcontent' ] = 'contains-slick-default';
$GLOBALS[ 'TCA' ][ 'tt_content' ][ 'types' ][ 'slickcontent' ][ 'showitem' ] = ''
				...
				. '  --palette--;LLL:EXT:start/Configuration/TCA/Overrides/8.7/tt_content.xlf:tx_start_palettecss;tx_start_palettecss,'
...
$GLOBALS[ 'TCA' ][ 'tt_content' ][ 'columns' ][ 'pi_flexform' ][ 'config' ][ 'ds' ][ ',slickcontent' ] = 'FILE:EXT:slick/Configuration/FlexForms/8.7/Slickcontent/flexform.xml';

	// #i0054, 190502, dwildt, 5+
/**
 * slickfilecollection
 */
$GLOBALS[ 'TCA' ][ 'tt_content' ][ 'ctrl' ][ 'typeicon_classes' ][ 'slickfilecollection' ] = 'contains-slick-default';
 ...
 * slickimage
 */
$GLOBALS[ 'TCA' ][ 'tt_content' ][ 'ctrl' ][ 'typeicon_classes' ][ 'slickimage' ] = 'contains-slick-default';
...
;
$GLOBALS[ 'TCA' ][ 'tt_content' ][ 'columns' ][ 'pi_flexform' ][ 'config' ][ 'ds' ][ ',slickimage' ] = 'FILE:EXT:slick/Configuration/FlexForms/8.7/Slickcontent/flexform.xml';


$GLOBALS[ 'TCA' ][ 'tt_content' ][ 'columns' ][ 'pi_flexform' ][ 'config' ][ 'ds' ][ ',slickfilecollection' ] = 'FILE:EXT:slick/Configuration/FlexForms/8.7/Slickcontent/flexform.xml';
