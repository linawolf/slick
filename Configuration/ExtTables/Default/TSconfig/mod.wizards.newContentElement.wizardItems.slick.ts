	...
	elements {
		...
		carousel1 {
			...
			tt_content_defValues {
				...
				imagecols = 1
				imageorient = 0
				header = LLL:EXT:slick/Resources/Private/Language/Backend.xlf:wizardItems.carousel.1.header
			}
		}
		carousel2 {
			iconIdentifier = app-slick-deprecated
			...
			tt_content_defValues {
				...
				imagecols = 1
				imageorient = 0
				header = LLL:EXT:slick/Resources/Private/Language/Backend.xlf:wizardItems.carousel.2.header
			}
		}
		carousel3 {
			iconIdentifier = app-slick-deprecated
			...
			tt_content_defValues {
				...
				imagecols = 1
				imageorient = 0
				header = LLL:EXT:slick/Resources/Private/Language/Backend.xlf:wizardItems.carousel.3.header
			}
		}
		gallery1 {
			iconIdentifier = app-slick-deprecated
			...
			tt_content_defValues {
				...
				imagecols = 1
				imageorient = 0
				header = LLL:EXT:slick/Resources/Private/Language/Backend.xlf:wizardItems.gallery.1.header
			}
		}
		gallery2 {
			iconIdentifier = app-slick-deprecated
			...
			tt_content_defValues {
				...
				imagecols = 1
				imageorient = 0
				header = LLL:EXT:slick/Resources/Private/Language/Backend.xlf:wizardItems.gallery.2.header
			}
		}
		gallery3 {
			iconIdentifier = app-slick-deprecated
			...
			tt_content_defValues {
				...
				imagecols = 1
				imageorient = 0
				header = LLL:EXT:slick/Resources/Private/Language/Backend.xlf:wizardItems.gallery.3.header
			}
		}
	}
	show := addToList(*)
